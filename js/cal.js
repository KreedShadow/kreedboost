...
function calc(){
	...
	{
		full_summ = $("#s2 option:selected").attr('data-price') - $("#s1 option:selected").attr('data-price')
                
                if($("#onemore").prop("checked")) full_summ = full_summ + 75;
                if($("#skincheck").prop("checked")) full_summ = full_summ * 1.45;
                if($("#lobbycheck").prop("checked")) full_summ = full_summ * 1.50;
